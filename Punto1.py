...
def initialization_equilateral_triangle():
    x = float(input("Enter the x coordinate for the triangle's bottom-left corner: "))
    y = float(input("Enter the y coordinate for the triangle's bottom-left corner: "))
...
def initialization_scalene_triangle():
    x1 = float(input("Enter the x coordinate for the first vertex: "))
    y1 = float(input("Enter the y coordinate for the first vertex: "))
    x2 = float(input("Enter the x coordinate for the second vertex: "))
    y2 = float(input("Enter the y coordinate for the second vertex: "))
    x3 = float(input("Enter the x coordinate for the third vertex: "))
    y3 = float(input("Enter the y coordinate for the third vertex: "))
    scalene_triangle = Scalene(False, x1, y1, x2, y2, x3, y3, x1, y1, x2, y2, x3, y3, math.degrees(math.acos((math.pow(scalene_triangle.edge1.length, 2) + math.pow(scalene_triangle.edge2.length, 2) - math.pow(scalene_triangle.edge3.length, 2)) / (2 * scalene_triangle.edge1.length * scalene_triangle.edge2.length))), math.degrees(math.acos((math.pow(scalene_triangle.edge1.length, 2) + math.pow(scalene_triangle.edge3.length, 2) - math.pow(scalene_triangle.edge2.length, 2)) / (2 * scalene_triangle.edge1.length * scalene_triangle.edge3.length))), math.degrees(math.acos((math.pow(scalene_triangle.edge2.length, 2) + math.pow(scalene_triangle.edge3.length, 2) - math.pow(scalene_triangle.edge1.length, 2)) / (2 * scalene_triangle.edge2.length * scalene_triangle.edge3.length))), scalene_triangle.edge1.length, scalene_triangle.edge2.length, scalene_triangle.edge3.length)
...
def initialization_isosceles_triangle():
    x = float(input("Enter the x coordinate for the triangle's bottom-left corner: "))
    y = float(input("Enter the y coordinate for the triangle's bottom-left corner: "))
    base_length = float(input("Enter the triangle's base length: "))
    equal_side_length = float(input("Enter the triangle's equal side length: "))
